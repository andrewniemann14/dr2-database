...
# ) -> BaseHTTPResponse:
def request(method: str, url: str, *, body: Optional[_TYPE_BODY] = None, fields: Optional[_TYPE_FIELDS] = None, headers: Optional[Mapping[str, str]] = None, preload_content: Optional[bool] = True, decode_content: Optional[bool] = True, redirect: Optional[bool] = True, retries: Optional[Union[Retry, bool, int]] = None, timeout: Optional[Union[Timeout, float, int]] = 3, json: Optional[Any] = None):
# ) -> BaseHTTPResponse:
  """
